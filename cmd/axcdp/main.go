...
func main() {
	...
	flag.StringVar(&verifyTarget, "verify-target", "", "verify one target on a running axcdp endpoint")
	flag.StringVar(&target, "target", "", "target title, id, or URL substring for -verify-target")
