...
func computerUseInstructions() string {
	return strings.Join([]string{
		...
		"",
		"Use native_revoke_approval with exact bundle_id to withdraw app approval, including stopped apps. This affects cooperating backends, not macOS permissions. Never automatically retry a failed or uncertain revocation.",
