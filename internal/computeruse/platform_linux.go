...
func PlatformStatus() PlatformReport {
	...
	default:
		caps = append(caps, PlatformCapability{Name: "input", Available: true, Message: "xdotool-backed X11 pixel clicks, scrolls, keys, and element-centered clicks/text input are available at " + xdotoolPath})
	}
	if display == "" {
